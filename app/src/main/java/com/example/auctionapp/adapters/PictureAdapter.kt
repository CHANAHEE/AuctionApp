...
class PictureAdapter(var context:Context, var items:MutableList<PictureItem>, var binding2: ActivitySellingEditBinding) : Adapter<PictureAdapter.VH>() {
    ...
    override fun onBindViewHolder(holder: VH, position: Int) {
        ...
        holder.binding.btnCancel.setOnClickListener {
            ...
            binding2.btnImage.text = "${items.size} / 10"
            if(items.size != 10) binding2.btnImage.visibility = View.VISIBLE
