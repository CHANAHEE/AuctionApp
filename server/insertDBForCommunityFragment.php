<?php
    ...
    $sql = "INSERT INTO post_community(title,image,location,place_info,description,nickname,now) VALUES ( '$title' , '$arrayString' , '$location' , '$placeinfo' , '$description' , '$nickname' , '$now' )";
